...
class CSICameraNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter("camera.frame_id", "csi_camera_frame")
        ...
        self.frame_publish_hz = self.get_parameter("publish_hz").get_parameter_value().double_value
        ...
        self.frame_publish_timer = self.create_timer(1/self.frame_publish_hz, self._publish)
